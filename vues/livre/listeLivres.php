...
<div class="container mt-5">
    ...
    <div class="row pt-5">
        ...
        <div class="col-4"><a href="index.php?uc=livres&action=add" class='btn btn-success'><i class="fas fa-plus-circle"></i> Créer un livre</a> </div>
    ...
    <tbody>
        ...
        foreach($lesLivres as $livre){
            ...
            echo "<td class='col-md-1'>".$livre->nomauteur."</td>";
